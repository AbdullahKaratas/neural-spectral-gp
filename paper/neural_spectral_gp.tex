...
\textbf{[TO BE COMPLETED: This section will document all experiments from PLAN.md]}

\textbf{Synthetic Kernels Tested:}
\begin{enumerate}
\item Silverman kernel (locally stationary): Completed ✓
\item Mat\'ern with spatially-varying lengthscale: TODO
\item Squared Exponential with varying amplitude: TODO
\item Gibbs kernel: TODO
\end{enumerate}
